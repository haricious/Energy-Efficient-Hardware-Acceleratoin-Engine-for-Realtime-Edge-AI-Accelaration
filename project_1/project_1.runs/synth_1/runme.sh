...
HD_PWD='D:/Projects/SIXXIS/Energy Efficient Hardware Acceleratoin Engine for Realtime Edge AI Accelaration/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ai_engine_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ai_engine_top.tcl
