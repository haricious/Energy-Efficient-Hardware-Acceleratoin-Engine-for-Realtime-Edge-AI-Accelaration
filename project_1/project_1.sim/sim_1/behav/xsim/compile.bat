...
REM
REM Generated by Vivado on Tue Mar 17 23:53:38 +0530 2026
...
echo "xvlog --incr --relax -prj tb_ai_engine_vlog.prj"
call xvlog  --incr --relax -prj tb_ai_engine_vlog.prj -log xvlog.log
